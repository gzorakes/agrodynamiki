...
function StihlSection() {
  return (
    <section className="mt-16 lg:mt-22 max-w-7xl mx-auto">
      ...
      <div className="text-main-700 text-justify space-y-5 lg:grid lg:grid-cols-4 gap-8">
        <p className="my-10 lg:my-0 order-1 lg:col-span-4">
        ...
        <Image
          ...
          alt="Stihl tools"
        />
        <p className="my-10 lg:my-0 order-2 lg:col-span-4">
